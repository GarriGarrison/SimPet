...
<use xlinkHref="#s-flower-m"></use>
 ...
 <g id="Слой_x0020_1">
  ...
  <path className={`${classes.fil4} ${classes.str0}`} onclick={btnAudioPause} d="M887.56 350.58l250.76 0c-14.97,-87.8 -36.44,-169.11 -64.42,-243.9 -4.63,-12.38 -15.89,-20.18 -29.1,-20.18l-201.08 0c-10.74,0 -19.98,4.96 -25.91,13.92 -5.93,8.96 -6.89,19.4 -2.69,29.29 30.22,71.22 53.76,145.63 72.44,220.88z"/>
  ...
  <path className={classes.fil1} d="M1318.3 306.57l293.98 0c3.99,0 7.43,-1.69 9.86,-4.86 2.43,-3.17 3.18,-6.93 2.14,-10.78l-52.81 -196.87c-1.27,-4.74 -4.93,-8.11 -9.76,-9 -87.57,-16.11 -180.08,-24.39 -292.37,-1.24 -3.41,0.7 -6.09,2.55 -7.96,5.48 -1.87,2.93 -2.42,6.14 -1.63,9.53l46.44 198.16c1.33,5.69 6.26,9.59 12.1,9.59z"/>
