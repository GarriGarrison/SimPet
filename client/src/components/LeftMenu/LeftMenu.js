...
<use xlinkHref="#s-flower-m"></use>
 ...
 <g id="Слой_x0020_1">
  ...
  <path className={`${classes.fil4} ${classes.str0}`} d="M955.38 822.37l1.03 11.57c1.44,16.08 14.81,28.31 30.95,28.31l141.5 0c16.5,0 30.09,-12.85 31.02,-29.32 4.23,-74.89 5.42,-146.73 3.55,-215.52l-227.23 0c8.57,67.91 14.7,136.15 19.12,204.22 0.02,0.26 0.03,0.49 0.06,0.75z"/>
