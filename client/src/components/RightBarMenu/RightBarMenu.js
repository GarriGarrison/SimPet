...
let timeout = {
  ...
  const [comfortColor, setComfortColor] = useState('green')
  const [fiveColor, setFiveColor] = useState('green')
  const [sixColor, setsixColor] = useState('green')
...
useEffect(()=>{
 ...
 <g id="_2087790228736">
  ...
  <polygon className={classes.fil11} style={{color: communColor}}  points={`1751.47,421.83 ${1751.47+((2585.71-1751.47)/100*communProgress)},421.83 ${1751.47+((2585.71-1751.47)/100*communProgress)},478.97 1751.47,478.97`}/>
  ...
  <polygon className={classes.fil11}  style={{color: eatColor}} points={`452.74,421.83 ${452.74+((1286.98-452.74)/100*eatProgress)},421.83 ${452.74+((1286.98-452.74)/100*eatProgress)},478.97 452.74,478.97`}/>
  ...
  <polygon className={classes.fil11} style={{color: medicinColor}}  points={`1751.47,733.74 ${1751.47+((2585.71-1751.47)/100*medicinProgress)},733.74 ${1751.47+((2585.71-1751.47)/100*medicinProgress)},790.88 1751.47,790.88`}/>
  <polygon className={classes.fil11} style={{color: comfortColor}} points={`1751.47,1045.65 ${1751.47+((2585.71-1751.47)/100*comfortProgress)},1045.65 ${1751.47+((2585.71-1751.47)/100*comfortProgress)},1102.79 1751.47,1102.79`}/>
  ...
  <polygon className={classes.fil11} style={{color: fiveColor}} points={`452.74,733.74 ${452.74+((1286.98-452.74)/100*fiveProgress)},733.74 ${452.74+((1286.98-452.74)/100*fiveProgress)},790.88 452.74,790.88`}/>
  <polygon className={classes.fil11} style={{color: sixColor}} points={`452.74,1045.65 ${452.74+((1286.98-452.74)/100*sixProgress)},1045.65 ${452.74+((1286.98-452.74)/100*sixProgress)},1102.79 452.74,1102.79`}/>
